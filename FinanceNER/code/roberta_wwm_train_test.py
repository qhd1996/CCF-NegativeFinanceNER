...
output_path = "../output/"
output_filename = "roberta_wwm_output.pkl"
...
log_path = '../log/'
logger = logging.getLogger('roberta_wwm_logger')
...
roberta_wwm_path = '../input/roberta_wwm/'
data_path = '../input/'
outdir = '../output/'

config_path = roberta_wwm_path + "bert_config.json"
checkpoint_path = roberta_wwm_path
dict_path = roberta_wwm_path + "vocab.txt"
...
with open(data_path+'Submit_Example.csv', 'r') as f, \
    open(outdir+'roberta_wwm.csv' ,'w') as fw:
